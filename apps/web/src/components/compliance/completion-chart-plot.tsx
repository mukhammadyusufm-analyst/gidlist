...
/**
 * Completion rate per day — the Recharts half, loaded on demand.
 *
 * Split from `completion-chart.tsx` because Recharts is 361 KB, and it was in
 * the first load of the compliance route whether or not there was anything to
 * plot. The loader next door decides; this file is only ever fetched once there
 * is data for it.
 *
 ...
 */
export function CompletionChartPlot({ data }: { data: Point[] }) {
  const { locale } = useT();
