...
export const en = {
  ...
  'checklist.templatePlaceTitle': 'Where do people check in?',
  'checklist.templatePlaceHint': 'These items can only be ticked within this distance of the place you choose, and only inside their time windows. You can change both later in each item\'s Conditions.',
  'checklist.templatePlaceChosen': 'Place chosen: {lat}, {lng}',
  'checklist.templatePlaceRadius': 'Distance allowed, in metres',
  'checklist.templateCreate': 'Create the checklist',
  ...
  'compliance.exportYes': 'Yes',
  'compliance.exportNotDone': 'Not done',
  'compliance.exportNotes': 'Notes',
  'compliance.exportAttachments': 'Photos and files',
  'compliance.exportDone': 'Done',
  'compliance.reportContents': 'Records in this report',
  'compliance.reportTicked': '{done} of {total} ticked',
  'compliance.reportNotOpened': 'Nobody opened this checklist, so there are no items to show.',
  ...
  'errors.templateNeedsPlace': 'Choose the workplace on the map first.',
