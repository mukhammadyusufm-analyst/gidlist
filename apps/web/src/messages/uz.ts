...
export const uz = {
  ...
  'date.today': 'Bugun',
  'date.prevMonth': 'Oldingi oy',
  'date.nextMonth': 'Keyingi oy',
  ...
  'checklist.windowTo': 'Gacha',
  'checklist.windowNote': 'Jadval vaqt mintaqasi boʻyicha hisoblanadi. Yarim tundan oʻtadigan oyna uchun tugashini boshlanishidan oldinroq qiling, masalan 22:00 dan 02:00 gacha.',
  'checklistArchive.title': 'Chek-listni arxivlash',
  'checklistArchive.intro': 'U doskadan olib qoʻyiladi va boshqa jadvalga qoʻyib boʻlmaydi. Allaqachon toʻldirilgan hamma narsa oʻqilishi mumkin boʻlib qoladi, uni istalgan vaqtda tiklashingiz mumkin.',
  'checklistArchive.action': 'Arxivlash',
  'checklistArchive.restoreTitle': 'Chek-listni tiklash',
  'checklistArchive.restoreIntro': 'U doskaga qaytadi va yana jadvalga qoʻyilishi mumkin.',
  'checklistArchive.restore': 'Tiklash',
  'checklistArchive.deleteTitle': 'Butunlay oʻchirish',
  'checklistArchive.deleteIntro': 'Bu chek-list hech qachon toʻldirilmagan, shuning uchun unga hech narsa yozilmagan. Oʻchirish uni butunlay olib tashlaydi.',
  'checklistArchive.deleteConfirm': 'Tasdiqlash uchun {title} deb yozing',
  'checklistArchive.delete': 'Chek-listni oʻchirish',
  'checklistArchive.protected': 'Bu chek-list toʻldirilgan, shuning uchun uni faqat arxivlash mumkin. Uning toʻldirishlari hisobot yozuvi va saqlanib qolishi kerak.',
  ...
  'audit.search': 'Qidirish',
  'audit.searchLabel': 'Ism, pochta, amal yoki tafsilot boʻyicha qidirish',
  'audit.actionLabel': 'Amal',
  'audit.allActions': 'Barcha amallar',
  'audit.noMatches': 'Mos keladigani topilmadi.',
  'audit.showing': '{total} tadan {from}-{to} koʻrsatilmoqda',
  ...
  'audit.checklistPublished': '{actor} «{checklist}» roʻyxatining {version}-versiyasini chop etdi',
  'audit.checklistArchived': '{actor} «{checklist}» roʻyxatini arxivladi',
  'audit.checklistRestored': '{actor} «{checklist}» roʻyxatini tikladi',
  'audit.scheduleCreated': '{actor} «{checklist}» uchun jadval yaratdi',
  'audit.schedulePaused': '{actor} «{checklist}» jadvalini toʻxtatdi',
  'audit.scheduleResumed': '{actor} «{checklist}» jadvalini davom ettirdi',
  'audit.scheduleDeleted': '{actor} «{checklist}» jadvalini oʻchirdi — {count} ta yozuv olib tashlandi',
  'audit.submissionDeleted': '{actor} «{checklist}» ning {date} sanasidagi yozuvini oʻchirdi',
  ...
  'checklist.templatePlaceTitle': 'Qayerda belgilanadi?',
  'checklist.templatePlaceHint': 'Bu bandlarni faqat siz tanlagan joydan shu masofa ichida va faqat ularning vaqt oraligʻida belgilash mumkin. Ikkalasini keyinroq har bir bandning Shartlarida oʻzgartirishingiz mumkin.',
  'checklist.templatePlaceChosen': 'Tanlangan joy: {lat}, {lng}',
  'checklist.templatePlaceRadius': 'Ruxsat etilgan masofa, metrda',
  'checklist.templateCreate': 'Roʻyxatni yaratish',
  ...
  'checklist.preview': 'Oldindan koʻrish',
  'checklist.previewDraftIntro': 'v{version} qoralamasi toʻldiruvchiga qanday koʻrinadi. Bu yerda hech narsa yozilmaydi.',
  'checklist.previewPublishedIntro': 'v{version} toʻldiruvchiga qanday koʻrinadi. Bu yerda hech narsa yozilmaydi.',
  'checklist.previewEmpty': 'Hozircha koʻrsatadigan narsa yoʻq — avval bandlar qoʻshing.',
  ...
  'instructions.itemTitle': 'Koʻrsatmalar',
  'instructions.addText': 'Matn qoʻshish',
  'instructions.addFile': 'Fayl qoʻshish',
  'instructions.addVideo': 'Video havolasi',
  'instructions.textPlaceholder': 'Nima qilish kerakligi, bir necha qatorda',
  'instructions.videoPlaceholder': 'Video havolasi (YouTube, Google Drive)',
  'instructions.videoUrlInvalid': 'Bu havolaga oʻxshamaydi. U https:// bilan boshlanishi kerak.',
  'instructions.open': 'Ochish',
  'instructions.full': 'Bir bandga shuncha koʻrsatma sigʻadi ({n}).',
  'media.hintInstruction': 'PNG, JPEG, WebP yoki PDF, {mb} MB gacha.',
  ...
  'checklist.recordsLocation': 'joylashuv yoziladi',
  'checklist.locationRequired': 'Bu hududdan tashqarida belgilab boʻlmaydi',
  'checklist.locationRequiredHint': 'Oʻchirib qoʻysangiz, joylashuv baribir yoziladi, lekin hech kimga toʻsqinlik qilmaydi.',
  'checklist.locationRequiredDisabled': 'Buni yoqish uchun yuqorida joylashuvni belgilang.',
  'checklist.photo': 'Surat',
  'checklist.file': 'Fayl',
  'checklist.enforced': 'Belgilash uchun majburiy',
  'checklist.photoOn': 'surat',
  'checklist.photoRequired': 'surat majburiy',
  'checklist.fileOn': 'fayl',
  'checklist.fileRequired': 'fayl majburiy',
  'checklist.requirements': 'Shartlar',
  'checklist.requiresAttachment': 'ilova majburiy',
  'checklist.requiresLocation': 'joylashuv majburiy',
  'checklist.evidenceRequired': 'Ilovasiz belgilab boʻlmaydi',
  'checklist.evidenceRequiredHint': 'Buni yoqish uchun yuqorida «Surat» yoki «Surat yoki fayl»ni tanlang.',
  'checklist.locationTitle': 'Belgilangan joyda belgilanishi kerak',
  'checklist.latitude': 'Kenglik',
  'checklist.longitude': 'Uzunlik',
  'checklist.radius': 'Radius (m)',
  'checklist.useMyLocation': 'Hozirgi joyimni olish',
  'checklist.pickOnMap': 'Xaritadan tanlash',
  'checklist.searchPlace': 'Joy yoki manzilni qidiring',
  'checklist.searchNothing': 'Hech narsa topilmadi. Yaqin koʻchani kiriting yoki belgini suring.',
  'checklist.mapHint': 'Xaritaga bosing yoki belgini suring. Doira radiusni koʻrsatadi.',
  'common.search': 'Qidirish',
  'checklist.locating': 'Aniqlanmoqda…',
  'checklist.locationUnsupported': 'Bu qurilma joylashuvini aniqlay olmaydi.',
  'checklist.locationDenied': 'Joylashuvni oʻqib boʻlmadi. Ruxsat bering va qayta urinib koʻring.',
  'checklist.locationAccuracyNote': 'Radiusni keng qoldiring. GPS koʻpincha oʻnlab metr xato qiladi, bino ichida esa yanada yomon — tor radius toʻgʻri joyda turgan odamni ham rad etadi. Eng kami — 25 m.',
  'checklist.evidenceLabel': 'Ilova',
  'checklist.evidenceNone': 'Ilovasiz',
  'checklist.evidencePhoto': 'Surat',
  'checklist.evidenceFile': 'Surat yoki fayl',
  'schedule.none':
  ...
  'fill.evidenceAddPhoto': 'Surat oling yoki tanlang',
  'fill.evidenceAddFile': 'Surat yoki fayl biriktiring',
  'fill.evidenceUploading': 'Yuklanmoqda…',
  'fill.evidenceWantsPhoto': 'Bu band surat soʻraydi. Hech narsa biriktirilmagan.',
  'fill.evidenceWantsFile': 'Bu band surat yoki fayl soʻraydi. Hech narsa biriktirilmagan.',
  ...
  'account.deleteSection': 'Hisobni oʻchirish',
  'account.deleteIntro': 'Kirish maʼlumotlaringiz, ismingiz va suratingiz butunlay oʻchiriladi. Siz toʻldirgan yozuvlar kompaniyangiz hisobotlarida email manzilingiz bilan qoladi. Agar maydon egasi boʻlsangiz, Gidlist yordam xizmatiga yozing — avval maydon boshqaga oʻtkazilishi yoki yopilishi kerak.',
  'account.deleteConfirmLabel': 'Tasdiqlash uchun {email} ni kiriting',
  'account.deleteAction': 'Hisobimni oʻchirish',
  'account.deleted': 'Hisobingiz oʻchirildi.',
  'errors.deleteAccountConfirm': 'Tasdiqlash uchun email manzilingizni aynan kiriting.',
  'errors.signInToDelete': 'Hisobni oʻchirish uchun tizimga kiring.',
  'errors.deleteAccountOwnsSpace': 'Siz kompaniyangiz yozuvlari saqlanadigan maydon egasisiz. Gidlist yordam xizmatiga yozing (Telegram @gidlist_support) — biz maydonni topshiramiz yoki yopamiz, soʻng hisobingizni oʻchiramiz.',
  ...
  'compliance.exportSpreadsheet': 'Jadvalni yuklab olish',
  'compliance.exportYes': 'Ha',
  'compliance.exportNotDone': 'Bajarilmagan',
  'compliance.exportNotes': 'Izohlar',
  'compliance.exportAttachments': 'Suratlar va fayllar',
  'compliance.exportDone': 'Bajarildi',
  'compliance.reportContents': 'Hisobotdagi yozuvlar',
  'compliance.reportTicked': '{total} tadan {done} tasi belgilangan',
  'compliance.reportNotOpened': 'Bu roʻyxatni hech kim ochmagan, shuning uchun koʻrsatiladigan bandlar yoʻq.',
  'compliance.printReport': 'Suratli hisobot',
  'compliance.exportSubmittedAt': 'Yuborilgan',
  'compliance.exportCompletedAt': 'Aloqasiz yakunlangan',
  'compliance.exportVoidReason': 'Bekor qilingan',
  'compliance.reportTitle': 'Bajarilish hisoboti',
  'compliance.reportCount': '{n} ta yozuv',
  'compliance.reportGenerated': '{at} da tuzilgan',
  'compliance.reportPage': 'Jadvalning {pages} sahifasidan {page}-sahifa. Kamroq sahifa chop etish uchun filtrlarni toraytiring.',
  'compliance.reportEmpty': 'Bu filtrlarga mos yozuv yoʻq.',
  'compliance.backToReport': 'Bajarilishga qaytish',
  'compliance.print': 'Chop etish yoki PDF saqlash',
  'compliance.noMatches': 'Bu filtrlarga mos toʻldirishlar yoʻq.',
  'status.void': 'Bekor qilingan',
  'compliance.void': 'Bekor qilish',
  'compliance.unvoid': 'Bekor qilishni qaytarish',
  'compliance.voidReason': 'Bu yozuv nega hisobga olinmaydi',
  'compliance.voidReasonPlaceholder': 'masalan, liniya taʼmirda edi',
  ...
  'compliance.schedule': 'Jadval',
  'compliance.allSchedules': 'Barcha jadvallar',
  'compliance.scheduleDeleted': 'Oʻchirilgan jadval',
  ...
  'errors.templateNeedsPlace': 'Avval ish joyini xaritadan tanlang.',
