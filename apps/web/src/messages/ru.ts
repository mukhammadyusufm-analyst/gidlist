...
export const ru = {
  ...
  'compliance.exportNo': 'Нет',
  'compliance.exportSection': 'Раздел',
  'compliance.exportItem': 'Пункт',
  'compliance.exportDone': 'Выполнено',
  'compliance.exportTickedAt': 'Время отметки',
  'compliance.exportNote': 'Заметка',
  'compliance.exportPhoto': 'Фото',
  'compliance.exportFile': 'Файл',
