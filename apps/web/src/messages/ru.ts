...
export const ru = {
  ...
  'auth.pitchTitle': 'Чек-листы, которые помогают доводить дела до конца.',
  'auth.pitchBody':
  ...
  'billing.managedOutsideApp': 'Ваш тариф оформляется напрямую с Gidlist, а не через это приложение. Изменить его может администратор вашего аккаунта.',
  'billing.intro':
  ...
  'checklist.templatePlaceTitle': 'Где отмечаются?',
  'checklist.templatePlaceHint': 'Эти пункты можно отметить только в пределах этого расстояния от выбранного места и только в их временном окне. Оба условия можно изменить позже в «Условиях» каждого пункта.',
  'checklist.templatePlaceChosen': 'Выбранное место: {lat}, {lng}',
  'checklist.templatePlaceRadius': 'Допустимое расстояние, в метрах',
  'checklist.templateCreate': 'Создать чек-лист',
  ...
  'instructions.itemTitle': 'Инструкции',
  'instructions.addText': 'Добавить текст',
  'instructions.addFile': 'Добавить файл',
  'instructions.addVideo': 'Ссылка на видео',
  'instructions.textPlaceholder': 'Что нужно сделать, в нескольких строках',
  'instructions.videoPlaceholder': 'Ссылка на видео (YouTube, Google Drive)',
  'instructions.videoUrlInvalid': 'Это не похоже на ссылку. Она должна начинаться с https://',
  'instructions.open': 'Открыть',
  'instructions.full': 'Больше инструкций к одному пункту добавить нельзя ({n}).',
  'media.hintInstruction': 'PNG, JPEG, WebP или PDF, до {mb} МБ.',
  ...
  'fill.outdatedTitle': 'У этого чек-листа есть новая версия',
  'fill.outdatedBody':
    'Его изменили после того, как вы начали. Эту попытку нельзя продолжить или отправить. Если начать заново, всё заполненное, включая прикреплённые фото и файлы, будет удалено.',
  'fill.restartOnNewVersion': 'Начать заново в новой версии',
  'fill.readOnly':
  ...
  'account.deleteSection': 'Удалить аккаунт',
  'account.deleteIntro': 'Ваш вход, имя и фото будут удалены навсегда. То, что вы заполнили, останется в отчётности вашей компании под вашим адресом почты. Если вы владелец пространства, напишите в поддержку Gidlist — сначала пространство нужно передать или закрыть.',
  'account.deleteConfirmLabel': 'Введите {email} для подтверждения',
  'account.deleteAction': 'Удалить мой аккаунт',
  'account.deleted': 'Ваш аккаунт удалён.',
  'errors.deleteAccountConfirm': 'Для подтверждения введите адрес почты точно.',
  'errors.signInToDelete': 'Войдите, чтобы удалить аккаунт.',
  'errors.deleteAccountOwnsSpace': 'Вы владелец пространства, в котором хранятся записи вашей компании. Напишите в поддержку Gidlist (Telegram @gidlist_support) — мы передадим или закроем его, а затем удалим аккаунт.',
  ...
  'compliance.exportSpreadsheet': 'Скачать таблицу',
  'compliance.exportYes': 'Да',
  'compliance.exportNotDone': 'Не выполнено',
  'compliance.exportNotes': 'Заметки',
  'compliance.exportAttachments': 'Фото и файлы',
  'compliance.exportDone': 'Выполнено',
  'compliance.reportContents': 'Записи в отчёте',
  'compliance.reportTicked': 'Отмечено {done} из {total}',
  'compliance.reportNotOpened': 'Этот чек-лист никто не открывал, поэтому пунктов нет.',
  'compliance.printReport': 'Отчёт с фото',
  'compliance.exportSubmittedAt': 'Отправлено',
  'compliance.exportCompletedAt': 'Завершено без связи',
  'compliance.exportVoidReason': 'Аннулировано',
  'compliance.reportTitle': 'Отчёт о выполнении',
  'compliance.reportCount': 'Записей: {n}',
  'compliance.reportGenerated': 'сформирован {at}',
  'compliance.reportPage': 'Страница {page} из {pages} таблицы. Сузьте фильтры, чтобы печатать меньше страниц.',
  'compliance.reportEmpty': 'Нет записей по этим фильтрам.',
  'compliance.backToReport': 'Назад к выполнению',
  'compliance.print': 'Печать или сохранить в PDF',
  ...
  'compliance.schedule': 'Расписание',
  'compliance.allSchedules': 'Все расписания',
  'compliance.scheduleDeleted': 'Удалённое расписание',
  ...
  'errors.templateNeedsPlace': 'Сначала выберите рабочее место на карте.',
  ...
  'errors.practiceReadOnly':
    'Учебный чек-лист нельзя изменить. Создайте свой чек-лист в собственном пространстве.',
  'errors.practiceNoSchedules':
    'Учебный чек-лист нельзя поставить в расписание повторно. Настраивайте расписание в собственном пространстве.',
  'errors.practiceNoMembers':
    'В учебное пространство нельзя приглашать участников. Приглашайте людей в собственное пространство.',
  'errors.submissionOutdated':
    'Опубликована новая версия этого чек-листа. Начните заново в новой версии.',
  ...
  'notices.resetLinkSent':
    'Если учётная запись с этим адресом существует, ссылка для сброса уже отправлена. Письмо может прийти через несколько минут — проверьте папку «Спам» и подождите хотя бы минуту, прежде чем запрашивать новую ссылку: слишком частый запрос не отправляется.',
